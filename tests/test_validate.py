    ...
    return pl.DataFrame(
        {
            ...
            "imo": [
                "IMO111", "IMO222", "IMO333", "IMO444",
                "IMO9234567", "IMO9345612", "IMO9456781", "IMO9678901",
            ],
            "vessel_name": [
                "ALPHA", "BRAVO", "CHARLIE", "DELTA",
                "PETROVSKY ZVEZDA", "SARI NOUR", "OCEAN VOYAGER", "VERA SUNSET",
            ],
            "vessel_type": ["Tanker", "Tanker", "Tanker", "Cargo", "Tanker", "Tanker", "Tanker", "Tanker"],
...
def test_label_watchlist_against_ofac(tmp_db):
    ...
    assert labeled["is_ofac_listed"].to_list() == [True, False, True, False, True, True, False, False]
