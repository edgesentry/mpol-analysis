...
DUMMY_MMSIS = {"273456782", "613115678", "352123456", "538009876"}

NEW_VESSELS = pl.DataFrame(
    {
        "mmsi": ["273456782", "613115678", "352123456", "538009876"],
        "imo": ["IMO9234567", "IMO9345612", "IMO9456781", "IMO9678901"],
        "vessel_name": ["PETROVSKY ZVEZDA", "SARI NOUR", "OCEAN VOYAGER", "VERA SUNSET"],
        "vessel_type": ["Tanker", "Tanker", "Tanker", "Tanker"],
        "flag": ["RU", "CM", "PA", "MH"],
        "confidence": [0.91, 0.87, 0.79, 0.72],
        "anomaly_score": [0.88, 0.84, 0.70, 0.55],
        "graph_risk_score": [0.92, 0.80, 0.75, 0.65],
        "identity_score": [0.75, 0.70, 0.25, 0.40],
        "top_signals": [
        ...
        "last_lat": [26.50, 29.10, 35.90, 25.10],
        "last_lon": [55.50, 50.30, -5.50, 56.40],
        "last_seen": [
        ...
        "ais_gap_count_30d": [14, 8, 3, 1],
        "ais_gap_max_hours": [22.0, 14.0, 7.5, 3.0],
        "position_jump_count": [2, 3, 0, 0],
        "sts_candidate_count": [2, 1, 5, 0],
        "flag_changes_2y": [2, 1, 0, 0],
        "name_changes_2y": [1, 2, 0, 1],
        "owner_changes_2y": [1, 1, 1, 2],
        "sanctions_distance": [1, 2, 3, 2],
        "shared_address_centrality": [3, 2, 5, 2],
        "sts_hub_degree": [3, 2, 6, 1],
        "cluster_label": [-1, -1, 0, 0],
        "baseline_noise_score": [1.0, 0.95, 0.30, 0.20],
    }
)
