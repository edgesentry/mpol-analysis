...
Measured using the multi-region candidate watchlist generated by `scripts/run_public_backtest_batch.py` (all 5 regions). This is the authoritative result for the multi-region P@50 ≥ 0.68 target.
